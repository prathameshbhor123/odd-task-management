...
const ContactUs = () => {
    ...
    return (
        <>
            ...
            <section className={`bg-gradient-to-tr from-yellow-50 to-yellow-100 pt-15 text-gray-800 min-h-screen flex items-center transition-all duration-1000 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
                <div className="container mx-auto px-4 max-w-6xl py-8">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Contact Us
                                <div className="w-16 h-1 bg-yellow-500 mt-2 rounded-full"></div>
                            </motion.h2>
                            ...
                            >
                                <motion.div className="space-y-4" variants={containerVariants}>
                                    <motion.div className="relative" variants={itemVariants}>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 sm:py-2 rounded-lg bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition-all duration-300 shadow-sm hover:shadow-md custom-focus"
                                            required
                                ...
                                <motion.div className="relative" variants={itemVariants}>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={4}
                                        className="w-full px-4 py-3 sm:py-2 rounded-xl bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition-all duration-300 shadow-sm hover:shadow-md custom-focus"
                                ...
                                >
                                    <motion.button
                                        type="submit"
                                        disabled={isSending}
                                        className="px-6 py-3 sm:py-2 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center font-medium"
                        ...
                        <motion.div
                            whileHover={cardHover}
                            className="w-full lg:w-1/2 bg-gradient-to-br from-yellow-50 to-yellow-200 p-4 sm:p-6 relative overflow-hidden overflow-y-auto max-h-[90vh] scrollbar-hide"
                        >
                            {/* Decorative elements */}
                            <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full bg-yellow-200 opacity-20"></div>
                            <div className="absolute -left-20 w-60 h-60 rounded-full bg-yellow-100 opacity-20"></div>
                            ...
                            >
                                <motion.div
                                    ...
                                    whileHover={{ x: 5 }}
                                >
                                    <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 p-2 rounded-lg mr-3 shadow-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                        </svg>
                                    </div>
                                    <div>
                                        <p className="text-yellow-700 font-medium mb-1">Registered Office</p>
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-yellow-700 font-medium mb-1">Works</p>
                                        <p className="text-gray-700">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-yellow-700 font-medium mb-1">Local Inquiry</p>
                                            <a
                                                href="tel:+919912567282"
                                                className="text-gray-700 hover:text-yellow-600 transition-colors duration-300 block"
                                            >
                                                +91 9912567282
                                            </a>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-yellow-700 font-medium mb-1">Global Inquiry</p>
                                            <a
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-yellow-700 font-medium mb-1">Connect With Us</p>
                                        <div className="flex space-x-4 mt-2">
                                            <a
                                                href="https://www.facebook.com/oddtech"
                                                className="relative group text-gray-700 hover:text-[#1877F2] transition-all duration-500"
                                            >
                                                <div className="absolute -inset-1 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-full opacity-0 group-hover:opacity-50 blur-sm group-hover:animate-pulse transition-all duration-300"></div>
                                                <svg
                                            ...
                                            <a
                                                href="#"
                                                className="text-gray-700 hover:text-[#1DA1F2] transition-all duration-300 group"
                                            >
                                                <svg
                                            ...
                                            <a
                                                href="https://www.instagram.com/odd_creatives/"
                                            ...
                                            <a
                                                href="#"
                                                className="text-gray-700 hover:text-gray-900 transition-all duration-300 group"
                                            >
                                                <div className="relative">
                                                    <div className="absolute -inset-0.5 bg-gray-200 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-pulse transition-opacity duration-300"></div>
                                                    <svg
                                                        className="w-6 h-6 relative transform group-hover:-translate-y-1 group-hover:scale-110 transition-all duration-300 group-hover:drop-shadow-[0_0_8px_rgba(36,41,46,0.4)]"
                                                        fill="currentColor"
                                                        viewBox="0 0 24 24"
                                                    >
